    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        altCatLivros.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String resultado = crud.alteraRegistroCatLivros((Integer.parseInt(ID_LIVROS), DIAS_LIVROS, DESCRICAO_LIVROS, TAXA_LIVROS);
        ...
        altCatLivros.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AltCatLivros.this, MenuCatLivros.class);
